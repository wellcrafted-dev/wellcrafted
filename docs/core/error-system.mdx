...
At the heart of wellcrafted's error system is the `TaggedError` type: a structured, serializable error representation that works with TypeScript's type system.
