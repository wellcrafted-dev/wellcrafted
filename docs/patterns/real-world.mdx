...
const { AuthServiceError, AuthServiceErr } = defineError("AuthServiceError");
...
// Service errors
const { FileServiceError, FileServiceErr } = defineError("FileServiceError");
...
const { ValidationError, ValidationErr } = defineError("ValidationError");
